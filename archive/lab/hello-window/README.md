...
```text
archive/lab/hello-window/dist/helloworld-x86-64.exe
archive/lab/hello-window/dist/helloworld-x86-64.exe.sha256
archive/lab/hello-window/dist/helloworld-resourced-x86-64.exe
archive/lab/hello-window/dist/helloworld-resourced-x86-64.exe.sha256
archive/lab/hello-window/dist/helloworld-pure-c-x86-64.exe
archive/lab/hello-window/dist/helloworld-pure-c-x86-64.exe.sha256
```

For the MiniCon profile split, generated files are:

```text
archive/lab/hello-window/dist/minicon-debug-stripped-x86-64.exe
archive/lab/hello-window/dist/minicon-debug-unstripped-x86-64.exe
archive/lab/hello-window/dist/minicon-release-fast-stripped-x86-64.exe
archive/lab/hello-window/dist/minicon-release-fast-unstripped-x86-64.exe
archive/lab/hello-window/dist/minicon-debug-opt-z-x86-64.exe
archive/lab/hello-window/dist/minicon-release-fast-opt-0-x86-64.exe
```
