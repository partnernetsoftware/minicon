...
`archive/lab/hello-window` remains the Win32/QVM size court. It is not this lab.
...
Receipts: `archive/lab/tinygui/target/court-six-receipts.jsonl` and `RESULTS.md`.
