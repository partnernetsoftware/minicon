...
```sh
sh archive/research/hello-memory/build.sh
python3 archive/research/hello-memory/run.py
python3 archive/research/hello-memory/run-styles.py
python3 archive/research/hello-memory/run-compat.py
python3 archive/research/hello-memory/collect-stacks.py
python3 archive/research/hello-memory/run-input.py
python3 archive/research/hello-memory/run-input-stages.py
```
...
Probe source and compact numeric results are retained in `archive/research/hello-memory/`;
...
```sh
python3 archive/research/hello-memory/run-init-stages.py
python3 archive/research/hello-memory/run-locale.py
INIT_COMPONENTS=1 python3 archive/research/hello-memory/run-locale.py
```

Compact samples: `archive/research/hello-memory/init-results.json`,
...
Reproduce: `INIT_MENUS=1 python3 archive/research/hello-memory/run-locale.py`.
Compact samples: `archive/research/hello-memory/menu-stage-results.json`.
