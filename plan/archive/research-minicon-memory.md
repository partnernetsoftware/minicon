...
The reproducible probe is retained as `archive/research/minicon-memory/probe.py`
...
Retained reproduction inputs: `archive/research/minicon-memory/no-separators.patch`
...
`python3 archive/research/minicon-memory/menu-comparison.py`. Detailed logs remain in
...
Reproduction inputs: `archive/research/minicon-memory/allocator-relief.patch`,
...
`python3 archive/research/minicon-memory/allocator-relief.py`. Restore product source
