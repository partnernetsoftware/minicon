...
`archive/research/rss-ledger/ledger.c` is a research-only dynamic library. It matches
...
```sh
sh archive/research/rss-ledger/build.sh
python3 archive/research/rss-ledger/run.py --group calibrate
# Obtain the coordinated GUI window before the following three commands.
python3 archive/research/rss-ledger/run.py --group product
python3 archive/research/rss-ledger/run.py --group native --repeats 2
python3 archive/research/rss-ledger/run.py --group stages --repeats 1
python3 archive/research/rss-ledger/summarize.py
```

Research inputs, compact receipts and source reference are under
`archive/research/rss-ledger/`. Generated frozen executables, JSONL time series and
