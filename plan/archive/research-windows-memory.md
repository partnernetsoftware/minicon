...
Hang evidence (keep): `archive/research/windows-memory/hang-last-step.md`.
...
Handoff `archive/research/windows-memory/delay-gdiplus-handoff.md`; do not bump
pin `745f52b2`. Do not re-run wrapper / 8-page / size-compare / skip-Focus.

## Top 5 live owners and verifiable interventions

Working file: `archive/research/windows-memory/live-owners.md`.
...
Logs: `archive/research/windows-memory/live-owners.md`.
Driver: `archive/research/windows-memory/run-close-owners.sh`.

Do not edit `src/`, Cargo, or the public memory PRD from this branch.

Logs and artifacts: `archive/research/windows-memory/`, `target/windows-memory/`.
