...
```sh
python3 research/frame-lifetime/prepare.py
python3 research/frame-lifetime/instrument.py
...
python3 research/frame-lifetime/run.py
FRAME_TRACE_MODE=0 python3 research/frame-lifetime/run.py
python3 research/frame-lifetime/summarize.py
```
...
`research/frame-lifetime/results.json`. Full host logs, frame timeline,
...
Reproducer: `python3 research/frame-lifetime/compare-screenshots.py`.
...
PNG decode results: `research/frame-lifetime/screenshot-results.json`.
