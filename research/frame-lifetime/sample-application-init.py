...
binary=out/'probe'
s.run(['clang','-O2','-g','-fobjc-arc','-framework','Cocoa','-framework','QuartzCore','-framework','CoreGraphics','-Wl,-sectcreate,__TEXT,__info_plist,research/hello-memory/compat.plist','research/frame-lifetime/external-pages.c',str(out/'probe.m'),'-o',str(binary)],check=True)
