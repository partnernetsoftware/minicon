...
Status: **G1–G7 green; waiting only for exact user `v0.1.3 promote`**. Do not
modify or backfill v0.1.2.
...
- [ ] G8: no tag or Release until the user says exactly `v0.1.3 promote`.
