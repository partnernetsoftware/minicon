...
Status: **implementation active; Promotion forbidden until exact user
`v0.1.3 promote`**. Do not modify or backfill v0.1.2.
...
- Cargo and payload identity are already 0.1.3.
- Unsigned run `33263135546` proved one clean build plus all six GUI/control
  courts, but predates this policy and is rehearsal evidence only.
- Historical APE Candidate/Defender/signing research belongs to v0.1.4 and may
  not be promoted as v0.1.3.
- Remaining: commit this policy, run one exact-SHA build, seal/execute the new
  five-archive Candidate, scan both exact Windows executables, then stop at G8.
